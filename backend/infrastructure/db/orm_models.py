...
They are intentionally separate from core/models.py (pure dataclasses)
to avoid coupling the domain to the persistence layer.

Conversion between ORM models and domain models happens
exclusively inside repositories.py.
"""
...
class TransactionORM(Base):
    ...
    date              = mapped_column(Column(Date,        nullable=False))
